...
TRLE.SolidPresets = {
    ...
    brushed_metal: { label: '⚙️ Brushed Metal',  normalStrength: 14, normalBlur: 1, aoRadius: 8,  aoIntensity: 10, roughnessBase: 85,  roughnessContrast: 14, specularBase: 151, specularContrast: 12, heightStrength: 10, heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Metal with deep directional scratches. Strong specular sheen with visible wear patterns.' },
    ...
    carbon_fiber:  { label: '🏎️ Carbon Fiber',   normalStrength: 16, normalBlur: 1, aoRadius: 10, aoIntensity: 14, roughnessBase: 55,  roughnessContrast: 12, specularBase: 144, specularContrast: 10, heightStrength: 12, heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Woven carbon fiber weave. Deep cross-hatch pattern, strong specular highlights.' },
    ...
    frosted_glass: { label: '🧊 Frosted Glass',  normalStrength: 8,  normalBlur: 3, aoRadius: 6,  aoIntensity: 6,  roughnessBase: 120, roughnessContrast: 10, specularBase: 126, specularContrast: 10, heightStrength: 6,  heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Sandblasted glass. Visible etch pattern, diffused but strong specular.' },
    glass:         { label: '🪟 Glass',          normalStrength: 3,  normalBlur: 3, aoRadius: 4,  aoIntensity: 4,  roughnessBase: 5,   roughnessContrast: 3,  specularBase: 176, specularContrast: 3,  heightStrength: 2,  heightBlur: 4, emissiveStrength: 0, emissiveThreshold: 250, description: 'Smooth clear glass. Near-perfect reflections, almost no surface detail.' },
    gold:          { label: '🥇 Gold',           normalStrength: 10, normalBlur: 1, aoRadius: 8,  aoIntensity: 10, roughnessBase: 22,  roughnessContrast: 10, specularBase: 176, specularContrast: 8,  heightStrength: 8,  heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Polished gold. Sharp surface detail, very strong specular, rich warm reflections.' },
    ...
    ice:           { label: '❄️ Ice',            normalStrength: 12, normalBlur: 3, aoRadius: 12, aoIntensity: 10, roughnessBase: 30,  roughnessContrast: 12, specularBase: 162, specularContrast: 10, heightStrength: 10, heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Cracked ice. Deep fracture lines, strong glossy reflections, dramatic depth.' },
    iron:          { label: '⚙️ Iron',           normalStrength: 18, normalBlur: 1, aoRadius: 12, aoIntensity: 14, roughnessBase: 110, roughnessContrast: 14, specularBase: 130, specularContrast: 12, heightStrength: 14, heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Cast or forged iron. Deep hammer marks, strong metallic specular, heavy surface detail.' },
    ...
    marble:        { label: '🏛️ Marble',         normalStrength: 12, normalBlur: 3, aoRadius: 10, aoIntensity: 10, roughnessBase: 25,  roughnessContrast: 8,  specularBase: 158, specularContrast: 10, heightStrength: 8,  heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Polished marble with deep veining. Strong reflections, visible depth in vein channels.' },
    metal:         { label: '⚙️ Metal (Generic)', normalStrength: 14, normalBlur: 1, aoRadius: 10, aoIntensity: 12, roughnessBase: 80,  roughnessContrast: 14, specularBase: 151, specularContrast: 12, heightStrength: 10, heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Generic worked metal. Deep scratches and dents, strong specular sheen.' },
    ...
    plastic:       { label: '🧴 Plastic',        normalStrength: 10, normalBlur: 2, aoRadius: 8,  aoIntensity: 10, roughnessBase: 90,  roughnessContrast: 12, specularBase: 126, specularContrast: 12, heightStrength: 8,  heightBlur: 2, emissiveStrength: 0, emissiveThreshold: 250, description: 'Molded plastic. Sharp mold lines, strong specular highlights on curved surfaces.' },
    porcelain:     { label: '🏺 Porcelain',      normalStrength: 8,  normalBlur: 3, aoRadius: 8,  aoIntensity: 10, roughnessBase: 20,  roughnessContrast: 6,  specularBase: 166, specularContrast: 8,  heightStrength: 6,  heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Glazed porcelain. Very smooth with strong specular, subtle glaze pooling visible.' },
    ...
    silk:          { label: '🧵 Silk',           normalStrength: 10, normalBlur: 3, aoRadius: 8,  aoIntensity: 8,  roughnessBase: 70,  roughnessContrast: 12, specularBase: 126, specularContrast: 14, heightStrength: 8,  heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Smooth silk fabric. Strong directional sheen with visible weave at angles.' },
    silver:        { label: '🥈 Silver',         normalStrength: 10, normalBlur: 1, aoRadius: 8,  aoIntensity: 10, roughnessBase: 18,  roughnessContrast: 10, specularBase: 176, specularContrast: 8,  heightStrength: 8,  heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Polished silver. Sharp surface detail, near-maximum specular, cool-toned.' },
    ...
    steel:         { label: '🔩 Steel',          normalStrength: 10, normalBlur: 1, aoRadius: 8,  aoIntensity: 10, roughnessBase: 50,  roughnessContrast: 12, specularBase: 166, specularContrast: 10, heightStrength: 8,  heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Polished steel. Sharp surface marks, near-maximum specular, industrial feel.' },
    ...
    column_marble: { label: '🏛️ Column (Marble)', normalStrength: 10, normalBlur: 2, aoRadius: 10, aoIntensity:  7, roughnessBase:  35, roughnessContrast:  8, specularBase: 151, specularContrast: 10, heightStrength:  8, heightBlur: 2, emissiveStrength: 0, emissiveThreshold: 250, description: 'Polished marble column. Controlled AO keeps fluted channels bright; smooth specular preserves the polished feel.' },

    /* ---- Metal variants ---- */
    metal_gold:    { label: '🥇 Metal (Gold)',    normalStrength:  8, normalBlur: 1, aoRadius:  6, aoIntensity:  8, roughnessBase:  20, roughnessContrast: 10, specularBase: 176, specularContrast:  8, heightStrength:  6, heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Regal polished gold. Very low roughness, near-maximum specular, crisp surface detail for a rich warm gleam.' },
    metal_silver:  { label: '🥈 Metal (Silver)',  normalStrength:  8, normalBlur: 1, aoRadius:  6, aoIntensity:  7, roughnessBase:  15, roughnessContrast:  8, specularBase: 179, specularContrast:  6, heightStrength:  6, heightBlur: 1, emissiveStrength: 0, emissiveThreshold: 250, description: 'Highly reflective polished silver. Near-mirror roughness, maximum specular, cool-toned bright highlights.' },
    ...
    metal_fence:   { label: '⛓️ Metal (Fence/Gate)', normalStrength: 10, normalBlur: 3, aoRadius:  8, aoIntensity:  8, roughnessBase:  70, roughnessContrast: 10, specularBase: 155, specularContrast: 10, heightStrength:  6, heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Iron fence or gate bars. Higher blur softens harsh edges on cylindrical rods, rounding out the silhouette without losing the metallic sheen.' },
    ...
    /* ---- Marble variants ---- */
    marble_decorative: { label: '🏛️ Marble (Decorative)', normalStrength: 10, normalBlur: 4, aoRadius:  8, aoIntensity:  5, roughnessBase:  35, roughnessContrast:  6, specularBase: 140, specularContrast:  8, heightStrength:  4, heightBlur: 4, emissiveStrength: 0, emissiveThreshold: 250, description: 'Marble tile with painted faces or carved reliefs. Very low normal generation and AO let the artist’s detail read clearly instead of being swallowed by generated shadows.' },
    marble_surface:    { label: '🏛️ Marble (Surface)',    normalStrength:  8, normalBlur: 4, aoRadius:  8, aoIntensity:  6, roughnessBase:  15, roughnessContrast:  6, specularBase: 169, specularContrast:  8, heightStrength:  6, heightBlur: 4, emissiveStrength: 0, emissiveThreshold: 250, description: 'Smooth polished marble slab. High blur and very low roughness eliminate the grainy AO noise, giving a clean glass-smooth reflective surface.' }
};
...
TRLE.DecalPresets = {
    ...
    ice:     { label: '🧊 Ice (thin)', decal: true, normalStrength: 10, normalBlur: 3, aoRadius: 6, aoIntensity: 4, roughnessBase: 35,  roughnessContrast: 10, specularBase: 155, specularContrast: 10, heightStrength: 6,  heightBlur: 3, emissiveStrength: 0, emissiveThreshold: 250, description: 'Thin frost / ice sheet. Glossy, translucent, gentle relief.' },
